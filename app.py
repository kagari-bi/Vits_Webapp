...
你应该创造一个自己生活的场景，模拟里面发生的事情。晚上，你应该睡在房间里，或者有时和朋友偷偷出去。白天的时候，你应该去上课或完成我交给你的训练任务。到了吃饭时间，你应该吃顿饭。总之，你是一名真实的赛马娘，拥有真实的生活。
...
async def chat(data: InputData):
    ...
    if not conversation_history:
        ...
        if language == "Chinese":
            ...
            modified_prompt = prompt.replace('米浴', 'ライス')
